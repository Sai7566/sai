        ...
        >
          ...
          <div className="mt-4">
            <div className="px-3 py-2 bg-white rounded-lg shadow-sm">
              <h5 className="text-md font-semibold mb-3">Categories</h5>
            ...
            <div className="px-3 py-2 mt-4 bg-white rounded-lg shadow-sm">
              <h5 className="text-md font-semibold mb-3">Types</h5>
              <div className="flex flex-col gap-1 text-sm font-light">
            ...
            <div className="px-3 py-2 mt-4 bg-white rounded-lg shadow-sm">
              <h5 className="text-md font-semibold mb-3">Sort By</h5>
              <select
